                    ...
                    <form @submit.prevent="saveGeneralSettings" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input v-model="generalSettings.contact_email" type="email" class="input-field"
                                    required>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Commission plateforme
                                    (%)</label>
                                <input v-model.number="paymentSettings.platform_commission" type="number" min="0"
                                    max="100" step="0.1" class="input-field" required>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">TVA (%)</label>
                                <input v-model.number="paymentSettings.vat_rate" type="number" min="0" max="100"
