...
import { u as useSettings, _ as _sfc_main$1 } from './Logo-Bv7gA69-.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(authStore).isAuthenticated) {
        ...
        if (unref(showUserMenu)) {
          ...
          if (unref(userMenuOpen)) {
            ...
            _push(`<hr class="my-2 border-equestrian-gold/20"><button class="flex items-center space-x-2 w-full text-left px-4 py-3 text-red-600 hover:bg-red-50 transition-colors"><span>\u{1F6AA} Se d\xE9connecter</span></button></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` \u{1F3C7} S&#39;inscrire `);
            } else {
              return [
                createTextVNode(" \u{1F3C7} S'inscrire ")
              ];
            }
          }),
          _: 1
      ...
      _push(`</div><p class="text-equestrian-cream/80 mb-4"> La plateforme de r\xE9f\xE9rence pour r\xE9server vos cours d&#39;\xE9quitation avec des instructeurs certifi\xE9s. </p><div class="flex space-x-4">`);
      _push(ssrRenderComponent(_component_EquestrianIcon, {
        name: "trophy",
        size: 24,
...
//# sourceMappingURL=default-D_YUrgnN.mjs.map
