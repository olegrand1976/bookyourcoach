...
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderAttr } from 'vue/server-renderer';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isLoading.value) {
        ...
        _push(`<div class="flex items-center justify-center h-full" data-v-0309d8b5><div class="text-center text-gray-500" data-v-0309d8b5><div class="text-6xl mb-4" data-v-0309d8b5>\u{1F50D}</div><p data-v-0309d8b5>S\xE9lectionnez une entit\xE9 pour visualiser ses relations</p></div></div>`);
      } else if (graphData.value && !cytoscapeLoaded.value) {
        _push(`<div class="flex items-center justify-center h-full" data-v-0309d8b5><div class="text-center text-gray-500" data-v-0309d8b5><div class="text-6xl mb-4" data-v-0309d8b5>\u23F3</div><p data-v-0309d8b5>Chargement de la biblioth\xE8que de visualisation...</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="mt-4 p-4 bg-gray-50 rounded-lg" data-v-0309d8b5><h4 class="font-semibold text-gray-800 mb-2" data-v-0309d8b5>\u{1F3A8} L\xE9gende</h4><div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm" data-v-0309d8b5><div class="flex items-center" data-v-0309d8b5><div class="w-4 h-4 bg-blue-500 rounded-full mr-2" data-v-0309d8b5></div><span data-v-0309d8b5>Clubs</span></div><div class="flex items-center" data-v-0309d8b5><div class="w-4 h-4 bg-green-500 rounded-full mr-2" data-v-0309d8b5></div><span data-v-0309d8b5>Enseignants</span></div><div class="flex items-center" data-v-0309d8b5><div class="w-4 h-4 bg-purple-500 rounded-full mr-2" data-v-0309d8b5></div><span data-v-0309d8b5>Utilisateurs</span></div><div class="flex items-center" data-v-0309d8b5><div class="w-4 h-4 bg-orange-500 rounded-full mr-2" data-v-0309d8b5></div><span data-v-0309d8b5>Contrats</span></div></div></div></div>`);
    };
  }
};
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const syncLogs = ref([]);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gray-50" }, _attrs))} data-v-7527abb0><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" data-v-7527abb0><div class="mb-8" data-v-7527abb0><div class="flex items-center justify-between" data-v-7527abb0><div data-v-7527abb0><h1 class="text-3xl font-bold text-gray-900 text-center" data-v-7527abb0><span class="mr-3 text-primary-600" data-v-7527abb0>\u{1F4CA}</span> Analyse Graphique </h1><p class="mt-2 text-gray-600" data-v-7527abb0>Visualisez et analysez les relations entre les entit\xE9s de votre plateforme</p></div></div></div><div class="mb-8" data-v-7527abb0><nav class="flex space-x-8" data-v-7527abb0><button class="${ssrRenderClass([activeTab.value === "visualization" ? "border-blue-500 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700", "whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm"])}" data-v-7527abb0> Visualisation Interactive </button><button class="${ssrRenderClass([activeTab.value === "analytics" ? "border-blue-500 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700", "whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm"])}" data-v-7527abb0> Analyses Pr\xE9d\xE9finies </button><button class="${ssrRenderClass([activeTab.value === "sync" ? "border-blue-500 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-700", "whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm"])}" data-v-7527abb0> Synchronisation </button></nav></div>`);
      if (isLoading.value) {
      ...
      if (activeTab.value === "visualization") {
        _push(`<div class="bg-white rounded-lg shadow" data-v-7527abb0><div class="p-6" data-v-7527abb0><h2 class="text-xl font-semibold text-gray-900 mb-4" data-v-7527abb0>Visualisation Interactive du Graphe</h2><p class="text-gray-600 mb-6" data-v-7527abb0>S\xE9lectionnez une entit\xE9 pour visualiser ses relations dans le graphe</p>`);
      ...
      if (activeTab.value === "analytics") {
        _push(`<div class="bg-white rounded-lg shadow" data-v-7527abb0><div class="p-6" data-v-7527abb0><h2 class="text-xl font-semibold text-gray-900 mb-4" data-v-7527abb0>Analyses Pr\xE9d\xE9finies</h2><p class="text-gray-600 mb-6" data-v-7527abb0>Consultez des analyses pr\xE9d\xE9finies sur les donn\xE9es de votre plateforme</p><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" data-v-7527abb0><div class="bg-gray-50 rounded-lg p-4" data-v-7527abb0><h3 class="font-semibold text-gray-900 mb-2" data-v-7527abb0>\u{1F4C8} M\xE9triques Globales</h3>`);
        ...
        _push(`<button class="w-full px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700" data-v-7527abb0> \u{1F504} Actualiser </button></div><div class="bg-gray-50 rounded-lg p-4" data-v-7527abb0><h3 class="font-semibold text-gray-900 mb-2" data-v-7527abb0>\u{1F465} Relations Utilisateurs-Clubs</h3>`);
        ...
        _push(`<button class="w-full px-4 py-2 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700" data-v-7527abb0> \u{1F4C8} Analyser </button></div><div class="bg-gray-50 rounded-lg p-4" data-v-7527abb0><h3 class="font-semibold text-gray-900 mb-2" data-v-7527abb0>\u{1F3AF} Enseignants par Sp\xE9cialit\xE9</h3>`);
        ...
        _push(`<button class="w-full px-4 py-2 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-700" data-v-7527abb0> \u{1F3AF} Analyser </button></div><div class="bg-gray-50 rounded-lg p-4" data-v-7527abb0><h3 class="font-semibold text-gray-900 mb-2" data-v-7527abb0>\u{1F30D} R\xE9partition G\xE9ographique</h3>`);
        ...
        _push(`<button class="w-full px-4 py-2 bg-orange-600 text-white rounded-lg font-medium hover:bg-orange-700" data-v-7527abb0> \u{1F30D} Analyser </button></div><div class="bg-gray-50 rounded-lg p-4" data-v-7527abb0><h3 class="font-semibold text-gray-900 mb-2" data-v-7527abb0>\u{1F3C6} Performance des Clubs</h3>`);
        ...
        _push(`<button class="w-full px-4 py-2 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700" data-v-7527abb0> \u{1F3C6} Analyser </button></div><div class="bg-gray-50 rounded-lg p-4" data-v-7527abb0><h3 class="font-semibold text-gray-900 mb-2" data-v-7527abb0>\u{1F525} Sp\xE9cialit\xE9s Populaires</h3>`);
        ...
        _push(`<button class="w-full px-4 py-2 bg-indigo-600 text-white rounded-lg font-medium hover:bg-indigo-700" data-v-7527abb0> \u{1F525} Analyser </button></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (activeTab.value === "sync") {
        _push(`<div class="bg-white rounded-lg shadow" data-v-7527abb0><div class="p-6" data-v-7527abb0><h2 class="text-xl font-semibold text-gray-900 mb-4" data-v-7527abb0>Synchronisation Neo4j</h2><p class="text-gray-600 mb-6" data-v-7527abb0>G\xE9rez la synchronisation des donn\xE9es MySQL vers Neo4j</p>`);
        if (syncStats.value) {
        ...
        _push(`<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6" data-v-7527abb0><button${ssrIncludeBooleanAttr(isSyncing.value) ? " disabled" : ""} class="px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 disabled:bg-gray-400" data-v-7527abb0>${ssrInterpolate(isSyncing.value ? "\u23F3 Synchronisation..." : "\u{1F504} Synchronisation compl\xE8te")}</button><button class="px-4 py-2 bg-gray-600 text-white rounded-lg font-medium hover:bg-gray-700" data-v-7527abb0> \u{1F4CA} Actualiser le statut </button></div>`);
...
export { graphAnalysis as default };
//# sourceMappingURL=graph-analysis-gi226PqM.mjs.map
