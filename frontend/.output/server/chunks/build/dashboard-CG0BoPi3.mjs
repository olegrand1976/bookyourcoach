    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex-shrink-0" data-v-a4b11012${_scopeId}><svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a4b11012${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" data-v-a4b11012${_scopeId}></path></svg></div><div class="ml-3" data-v-a4b11012${_scopeId}><p class="text-sm font-medium text-blue-900" data-v-a4b11012${_scopeId}>Voir les le\xE7ons</p><p class="text-xs text-blue-700" data-v-a4b11012${_scopeId}>D\xE9couvrir les cours disponibles</p></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "ml-3" }, [
                createVNode("p", { class: "text-sm font-medium text-blue-900" }, "Voir les le\xE7ons"),
                createVNode("p", { class: "text-xs text-blue-700" }, "D\xE9couvrir les cours disponibles")
              ])
            ];
          }
        }),
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex-shrink-0" data-v-a4b11012${_scopeId}><svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a4b11012${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-v-a4b11012${_scopeId}></path></svg></div><div class="ml-3" data-v-a4b11012${_scopeId}><p class="text-sm font-medium text-green-900" data-v-a4b11012${_scopeId}>Mes r\xE9servations</p><p class="text-xs text-green-700" data-v-a4b11012${_scopeId}>G\xE9rer mes cours r\xE9serv\xE9s</p></div>`);
          } else {
            return [
              createVNode("div", { class: "flex-shrink-0" }, [
                (openBlock(), createBlock("svg", {
              ...
              createVNode("div", { class: "ml-3" }, [
                createVNode("p", { class: "text-sm font-medium text-green-900" }, "Mes r\xE9servations"),
                createVNode("p", { class: "text-xs text-green-700" }, "G\xE9rer mes cours r\xE9serv\xE9s")
              ])
            ];
          }
        }),
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex-shrink-0" data-v-a4b11012${_scopeId}><svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a4b11012${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" data-v-a4b11012${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-a4b11012${_scopeId}></path></svg></div><div class="ml-3" data-v-a4b11012${_scopeId}><p class="text-sm font-medium text-purple-900" data-v-a4b11012${_scopeId}>Mes pr\xE9f\xE9rences</p><p class="text-xs text-purple-700" data-v-a4b11012${_scopeId}>Personnaliser mes choix</p></div>`);
          } else {
            return [
              createVNode("div", { class: "flex-shrink-0" }, [
                (openBlock(), createBlock("svg", {
              ...
              createVNode("div", { class: "ml-3" }, [
                createVNode("p", { class: "text-sm font-medium text-purple-900" }, "Mes pr\xE9f\xE9rences"),
      ...
      _push(`</div></div><div class="bg-white rounded-lg shadow-md p-6" data-v-a4b11012><h2 class="text-lg font-semibold text-gray-900 mb-4" data-v-a4b11012>Activit\xE9 r\xE9cente</h2>`);
      if (recentActivity.value.length === 0) {
        _push(`<div class="text-center py-8" data-v-a4b11012><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-a4b11012><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" data-v-a4b11012></path></svg><h3 class="mt-2 text-sm font-medium text-gray-900" data-v-a4b11012>Aucune activit\xE9 r\xE9cente</h3><p class="mt-1 text-sm text-gray-500" data-v-a4b11012>Vos activit\xE9s appara\xEEtront ici.</p></div>`);
      } else {
...
//# sourceMappingURL=dashboard-CG0BoPi3.mjs.map
