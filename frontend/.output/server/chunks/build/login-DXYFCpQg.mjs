...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</p><p class="mt-1 text-center text-sm text-gray-600"> Vous \xEAtes enseignant ? `);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/register-teacher",
...
//# sourceMappingURL=login-DXYFCpQg.mjs.map
