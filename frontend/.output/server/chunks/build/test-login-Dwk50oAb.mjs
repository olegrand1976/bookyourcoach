...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(result)) {
        _push(`<div class="mt-6 p-4 bg-gray-100 rounded-md"><h3 class="font-semibold mb-2">R\xE9sultat :</h3><pre class="text-sm">${ssrInterpolate(JSON.stringify(unref(result), null, 2))}</pre></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(error)) {
...
//# sourceMappingURL=test-login-Dwk50oAb.mjs.map
