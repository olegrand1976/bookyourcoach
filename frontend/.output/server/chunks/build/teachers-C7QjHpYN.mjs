  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        _push(`<h3 class="text-lg font-semibold" data-v-97562392>Erreur de chargement</h3><p class="text-gray-600" data-v-97562392>${ssrInterpolate(unref(error).message)}</p></div><button class="btn-primary bg-equestrian-brown text-white" data-v-97562392> R\xE9essayer </button></div>`);
        ...
        ssrRenderList(unref(filteredTeachers), (teacher) => {
          ...
          ])}" data-v-97562392>${ssrInterpolate(teacher.is_available ? "Disponible" : "Occup\xE9")}</span></div></div><div class="p-6" data-v-97562392><div class="mb-4" data-v-97562392><h3 class="text-xl font-bold text-equestrian-darkBrown mb-1" data-v-97562392>${ssrInterpolate(teacher.first_name)} ${ssrInterpolate(teacher.last_name)}</h3><p class="text-equestrian-brown" data-v-97562392>${ssrInterpolate(teacher.title || "Instructeur \xE9questre")}</p></div>`);
          ...
          if (teacher.is_available) {
            _push(`<button class="btn-secondary border-equestrian-brown text-equestrian-brown hover:bg-equestrian-brown hover:text-white" data-v-97562392> R\xE9server </button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div></div>`);
...
//# sourceMappingURL=teachers-C7QjHpYN.mjs.map
