import { ref, hasInjectionContext, inject, getCurrentInstance, reactive, effectScope, isRef, isReactive, toRaw, getCurrentScope, onScopeDispose, watch, nextTick, toRefs, markRaw, computed, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, isReadonly, isShallow, mergeProps, withCtx, useSSRContext } from 'vue';
import { h as destr, k as klona, c as createError$1, i as hasProtocol, l as isScriptProtocol, m as joinURL, w as withQuery, n as getRequestHeader, o as isEqual, s as sanitizeStatusCode, p as setCookie, q as getCookie, r as deleteCookie, t as getContext, $ as $fetch$1, v as createHooks, x as executeAsync, y as toRouteMatcher, z as createRouter$1, A as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./index-BhLEp8MQ.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-zeKXtyvN.mjs')
  },
  {
    name: "centers",
    path: "/centers",
    component: () => import('./centers-DCXvyLMw.mjs')
  },
  {
    name: "coaches",
    path: "/coaches",
    component: () => import('./coaches-BNcMRJaG.mjs')
  },
  {
    name: "profile",
    path: "/profile",
  ...
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-tt--SumV.mjs')
  },
  {
    name: "teachers",
    path: "/teachers",
    component: () => import('./teachers-BmwxO5HX.mjs'),
    children: [
      {
        name: "teachers-id",
        path: ":id()",
        component: () => import('./_id_-Du0HBEtI.mjs')
      }
    ]
  },
  {
    name: "test-api",
    path: "/test-api",
    component: () => import('./test-api-BcuKoVez.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": "auth" },
    component: () => import('./dashboard-xsHVeYqE.mjs')
  },
  {
    name: "test-auth",
    path: "/test-auth",
    component: () => import('./test-auth-BXcjGdEQ.mjs')
  },
  {
    name: "club-space",
    path: "/club/space",
    component: () => import('./space-DozvXx0F.mjs')
  },
  {
    name: "debug-auth",
    path: "/debug-auth",
    component: () => import('./debug-auth-XmiSbabj.mjs')
  },
  {
    name: "test-links",
    path: "/test-links",
    component: () => import('./test-links-CemwoNdS.mjs')
  },
  {
    name: "test-login",
    path: "/test-login",
    component: () => import('./test-login-Dwk50oAb.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta$a || {}, ...{ "middleware": "admin" } },
    component: () => import('./index-BEi6NUIZ.mjs')
  },
  {
    name: "admin-users",
    path: "/admin/users",
    meta: { ...__nuxt_page_meta$9 || {}, ...{ "middleware": "admin" } },
    component: () => import('./users-BlADsem5.mjs')
  },
  {
    name: "colors-demo",
    path: "/colors-demo",
    component: () => import('./colors-demo-DDa6DjD2.mjs')
  },
  {
    name: "disciplines",
    path: "/disciplines",
    component: () => import('./disciplines-Bt4EFQgb.mjs')
  },
  {
    name: "club-profile",
    path: "/club/profile",
  ...
  },
  {
    ...
    component: () => import('./settings-DCNgoxfi.mjs')
  },
  {
    name: "club-dashboard",
    path: "/club/dashboard",
    meta: { "middleware": ["auth"] },
    component: () => import('./dashboard-CBpHqtHs.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./test-api-direct-CalNXHhJ.mjs')
  },
  {
    name: "register-teacher",
    path: "/register-teacher",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./register-teacher-CurMsEEr.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./dashboard-CG0BoPi3.mjs')
  },
  {
    name: "teacher-dashboard",
    path: "/teacher/dashboard",
    meta: { "middleware": ["auth"] },
    component: () => import('./dashboard-BzfBpVJ2.mjs')
  },
  {
    name: "test-auth-complete",
    path: "/test-auth-complete",
    component: () => import('./test-auth-complete-nlbSAKbO.mjs')
  },
  {
...
const namedMiddleware = {
  admin: () => import('./admin-o3tMyGPW.mjs'),
  "auth-admin": () => import('./auth-admin-DZR-F_lf.mjs'),
  auth: () => import('./auth-CDGvsuh4.mjs'),
  "role-control": () => import('./role-control-SMTuU_Kn.mjs'),
  student: () => import('./student-BenBxHgK.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-JX1p04v5.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BJHQVBZ2.mjs'));
...
export { useAuthStore as a, useRouter as b, useCookie as c, useNuxtApp as d, entry$1 as default, useRoute as e, asyncDataDefaults as f, createError as g, fetchDefaults as h, useRequestFetch as i, useRuntimeConfig as j, nuxtLinkDefaults as k, defineNuxtRouteMiddleware as l, navigateTo as n, resolveRouteObject as r, useHead as u };
