import { getCurrentInstance, ref, hasInjectionContext, inject, shallowRef, computed, reactive, effectScope, isRef, isReactive, toRaw, getCurrentScope, onScopeDispose, watch, nextTick, toRefs, markRaw, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, createApp, createVNode, Text, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isShallow, mergeProps, withCtx, useSSRContext } from 'vue';
import { h as destr, k as klona, c as createError$1, i as getRequestHeader, l as isEqual$1, s as sanitizeStatusCode, m as setCookie, n as getCookie, o as deleteCookie, p as getContext, $ as $fetch, q as createHooks, r as executeAsync, t as toRouteMatcher, v as createRouter$1, w as defu, x as getRequestHeaders } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index___fr",
    path: "/",
    component: () => import('./index-Cg_erUTm.mjs')
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    ...
    component: () => import('./login-C01uSGJi.mjs')
  },
  {
    name: "login___en",
    path: "/en/login",
  ...
  },
  {
    ...
    component: () => import('./profile-3C5rpJTJ.mjs')
  },
  {
    name: "profile___en",
    path: "/en/profile",
  ...
  },
  {
    ...
    component: () => import('./register-DIfKK4d3.mjs')
  },
  {
    name: "register___en",
    path: "/en/register",
  ...
  },
  {
    name: "teachers___fr",
    path: "/teachers",
    component: () => import('./teachers-C7QjHpYN.mjs'),
    children: [
      {
        name: "teachers-id___fr",
        path: ":id()",
        component: () => import('./_id_-Dc2w6XFS.mjs')
      }
    ]
  },
  {
  ...
  },
  {
    name: "test-api___fr",
    path: "/test-api",
    component: () => import('./test-api-Z5UKyaq6.mjs')
  },
  {
    name: "test-api___en",
    path: "/en/test-api",
  ...
  },
  {
    ...
    path: "/dashboard",
    meta: { "middleware": "auth" },
    component: () => import('./dashboard-Dtc8Rq2B.mjs')
  },
  {
    name: "dashboard___en",
    path: "/en/dashboard",
  ...
  },
  {
    name: "test-auth___fr",
    path: "/test-auth",
    component: () => import('./test-auth-CDCWNLTq.mjs')
  },
  {
    name: "test-auth___en",
    path: "/en/test-auth",
  ...
  },
  {
    ...
    path: "/debug-auth",
    component: () => import('./debug-auth-CokvVzUg.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./index-2C0cKAAO.mjs')
  },
  {
    name: "admin___en",
    path: "/en/admin",
  ...
  },
  {
    ...
    component: () => import('./users-DhxM_Xp0.mjs')
  },
  {
  ...
  },
  {
    ...
    path: "/admin/settings",
    meta: { "middleware": ["auth", "admin"] },
    component: () => import('./settings-BUP-Ai1j.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./test-api-direct-ClnpXwWo.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./dashboard-B-XyUsej.mjs')
  },
  {
...
const namedMiddleware = {
  admin: () => import('./admin-Bj3p_rOq.mjs'),
  "auth-admin": () => import('./auth-admin-9kxYnPKa.mjs'),
  auth: () => import('./auth-CpWNZrNB.mjs'),
  "role-control": () => import('./role-control-DpT6FdCQ.mjs')
};
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Cebygz44.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CmoTIHmI.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BtoCTMAi.mjs'));
...
export { useRouter as a, useI18n as b, useCookie as c, useNuxtApp as d, entry$1 as default, useRoute as e, asyncDataDefaults as f, createError as g, fetchDefaults as h, useRequestFetch as i, useRuntimeConfig as j, defineNuxtRouteMiddleware as k, hasProtocol as l, joinURL as m, navigateTo as n, withoutTrailingSlash as o, parseQuery as p, nuxtLinkDefaults as q, resolveRouteObject as r, defineStore as s, useHead as u, withTrailingSlash as w };
