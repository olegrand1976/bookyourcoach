...
import { _ as _imports_0 } from './virtual_public-Ru22WhcQ.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (userMenuOpen.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span${_scopeId}>\u{1F4CA}</span><span${_scopeId}>Dashboard</span>`);
            } else {
              return [
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span${_scopeId}>\u{1F465}</span><span${_scopeId}>Utilisateurs</span>`);
            } else {
              return [
                createVNode("span", null, "\u{1F465}"),
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span${_scopeId}>\u{1F4C4}</span><span${_scopeId}>Contrats</span>`);
            } else {
              return [
                createVNode("span", null, "\u{1F4C4}"),
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span${_scopeId}>\u2699\uFE0F</span><span${_scopeId}>Param\xE8tres</span>`);
            } else {
              return [
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span${_scopeId}>\u{1F517}</span><span${_scopeId}>Analyse Graphique</span>`);
            } else {
              return [
                createVNode("span", null, "\u{1F517}"),
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span${_scopeId}>\u{1F310}</span><span${_scopeId}>Retour au site</span>`);
            } else {
              return [
        ...
        _push(`<button class="flex items-center space-x-3 w-full text-left px-4 py-2 text-red-600 hover:bg-red-50"><span>\u{1F6AA}</span><span>D\xE9connexion</span></button></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=admin-x2Qv4JSt.mjs.map
