...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" }, _attrs))}><div class="mb-8"><h1 class="text-3xl font-bold text-gray-900"> Bienvenue, ${ssrInterpolate(unref(authStore).userName)} ! </h1><p class="mt-2 text-gray-600"> G\xE9rez vos cours et suivez vos progr\xE8s </p></div><div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8"><div class="card"><div class="flex items-center"><div class="p-2 bg-primary-100 rounded-lg">`);
      _push(ssrRenderComponent(unref(CalendarIcon), { class: "w-6 h-6 text-primary-600" }, null, _parent));
      _push(`</div><div class="ml-4"><p class="text-sm font-medium text-gray-600">Cours \xE0 venir</p><p class="text-2xl font-bold text-gray-900">${ssrInterpolate(unref(stats).upcoming_lessons)}</p></div></div></div><div class="card"><div class="flex items-center"><div class="p-2 bg-green-100 rounded-lg">`);
      ...
      if (unref(upcomingLessons).length === 0) {
        ...
        _push(`<p class="text-gray-500">Aucun cours programm\xE9</p>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/lessons/book",
...
//# sourceMappingURL=dashboard-DmD8ejPq.mjs.map
