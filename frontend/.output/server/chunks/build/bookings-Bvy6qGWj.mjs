...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const statusOptions = [
      ...
      { value: "confirmed", label: "Confirm\xE9es" },
      { value: "completed", label: "Termin\xE9es" },
      { value: "cancelled", label: "Annul\xE9es" }
    ];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bookings-page" }, _attrs))} data-v-1c22a316><div class="container mx-auto px-4 py-8" data-v-1c22a316><div class="mb-8" data-v-1c22a316><h1 class="text-3xl font-bold text-gray-900 mb-2" data-v-1c22a316> Mes R\xE9servations </h1><p class="text-gray-600" data-v-1c22a316> G\xE9rez vos cours r\xE9serv\xE9s et votre planning </p></div><div class="bg-white rounded-lg shadow-md p-6 mb-8" data-v-1c22a316><h2 class="text-lg font-semibold text-gray-900 mb-4" data-v-1c22a316>Filtrer par statut</h2><div class="flex flex-wrap gap-2" data-v-1c22a316><!--[-->`);
      ...
      if (loading.value) {
        ...
        ssrRenderList(filteredBookings.value, (booking) => {
          ...
          _push(`<button class="px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 transition-colors text-sm font-medium" data-v-1c22a316> D\xE9tails </button></div></div></div>`);
        });
        _push(`<!--]-->`);
        if (filteredBookings.value.length === 0) {
          _push(`<div class="text-center py-12" data-v-1c22a316><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-1c22a316><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-v-1c22a316></path></svg><h3 class="mt-2 text-sm font-medium text-gray-900" data-v-1c22a316>Aucune r\xE9servation</h3><p class="mt-1 text-sm text-gray-500" data-v-1c22a316>${ssrInterpolate(selectedStatus.value === "all" ? "Vous n'avez pas encore de r\xE9servations." : "Aucune r\xE9servation avec ce statut.")}</p>`);
          if (selectedStatus.value === "all") {
            ...
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(` Voir les le\xE7ons disponibles `);
                } else {
                  return [
                    createTextVNode(" Voir les le\xE7ons disponibles ")
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=bookings-Bvy6qGWj.mjs.map
