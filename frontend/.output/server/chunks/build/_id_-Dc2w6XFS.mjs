  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        _push(`</div><div class="bg-white rounded-xl shadow-lg p-6"><h2 class="text-2xl font-bold text-equestrian-darkBrown mb-4"> Avis des \xE9l\xE8ves </h2>`);
        ...
        _push(`</div></div><div class="space-y-6"><div class="bg-white rounded-xl shadow-lg p-6"><h3 class="text-xl font-bold text-equestrian-darkBrown mb-4"> R\xE9server un cours </h3>`);
        if (unref(teacher).is_available) {
          ...
          _push(` R\xE9server maintenant </button><button class="w-full btn-secondary border-equestrian-brown text-equestrian-brown hover:bg-equestrian-brown hover:text-white">`);
          _push(ssrRenderComponent(_component_Icon, {
...
//# sourceMappingURL=_id_-Dc2w6XFS.mjs.map
