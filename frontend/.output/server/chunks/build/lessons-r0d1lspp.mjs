      ...
      if (loading.value) {
        ...
        ssrRenderList(filteredLessons.value, (lesson) => {
          ...
          if (lesson.status === "available") {
            _push(`<button class="flex-1 bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors text-sm font-medium" data-v-8d87c433> R\xE9server </button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<button class="flex-1 bg-gray-100 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-200 transition-colors text-sm font-medium" data-v-8d87c433> D\xE9tails </button></div></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      if (!loading.value && !error.value && filteredLessons.value.length === 0) {
        _push(`<div class="text-center py-12" data-v-8d87c433><svg class="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-8d87c433><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" data-v-8d87c433></path></svg><h3 class="mt-2 text-sm font-medium text-gray-900" data-v-8d87c433>Aucune le\xE7on trouv\xE9e</h3><p class="mt-1 text-sm text-gray-500" data-v-8d87c433>Essayez de modifier vos filtres de recherche.</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
...
//# sourceMappingURL=lessons-r0d1lspp.mjs.map
