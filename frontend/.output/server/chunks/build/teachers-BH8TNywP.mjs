...
import { u as useFetch } from './fetch-CFnAc-Ix.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-8fc5759f><section class="bg-gradient-to-br from-blue-600 to-gray-800 text-white py-16" data-v-8fc5759f><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-8fc5759f><div class="text-center" data-v-8fc5759f><h1 class="text-4xl md:text-5xl font-bold mb-6 font-serif" data-v-8fc5759f> \u{1F40E} Nos Professeurs </h1><p class="text-xl text-gray-100 max-w-3xl mx-auto" data-v-8fc5759f> D\xE9couvrez nos instructeurs qualifi\xE9s et passionn\xE9s </p></div></div></section><section class="py-8 bg-gray-50" data-v-8fc5759f><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-8fc5759f><div class="flex flex-col md:flex-row gap-4 items-center justify-between" data-v-8fc5759f><div class="flex-1 max-w-md" data-v-8fc5759f><div class="relative" data-v-8fc5759f><input${ssrRenderAttr("value", unref(searchQuery))} type="text" placeholder="Rechercher un professeur..." class="w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-equestrian-brown focus:border-blue-600" data-v-8fc5759f><div class="absolute inset-y-0 right-0 pr-3 flex items-center" data-v-8fc5759f>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "heroicons:magnifying-glass",
        class: "h-5 w-5 text-gray-400"
      }, null, _parent));
      _push(`</div></div></div><div class="flex gap-4" data-v-8fc5759f><select class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-equestrian-brown focus:border-blue-600" data-v-8fc5759f><option value="" data-v-8fc5759f${ssrIncludeBooleanAttr(Array.isArray(unref(selectedDiscipline)) ? ssrLooseContain(unref(selectedDiscipline), "") : ssrLooseEqual(unref(selectedDiscipline), "")) ? " selected" : ""}>Toutes les disciplines</option><option value="dressage" data-v-8fc5759f${ssrIncludeBooleanAttr(Array.isArray(unref(selectedDiscipline)) ? ssrLooseContain(unref(selectedDiscipline), "dressage") : ssrLooseEqual(unref(selectedDiscipline), "dressage")) ? " selected" : ""}>Dressage</option><option value="jumping" data-v-8fc5759f${ssrIncludeBooleanAttr(Array.isArray(unref(selectedDiscipline)) ? ssrLooseContain(unref(selectedDiscipline), "jumping") : ssrLooseEqual(unref(selectedDiscipline), "jumping")) ? " selected" : ""}>Saut d&#39;obstacles</option><option value="cross" data-v-8fc5759f${ssrIncludeBooleanAttr(Array.isArray(unref(selectedDiscipline)) ? ssrLooseContain(unref(selectedDiscipline), "cross") : ssrLooseEqual(unref(selectedDiscipline), "cross")) ? " selected" : ""}>Cross</option><option value="pony_games" data-v-8fc5759f${ssrIncludeBooleanAttr(Array.isArray(unref(selectedDiscipline)) ? ssrLooseContain(unref(selectedDiscipline), "pony_games") : ssrLooseEqual(unref(selectedDiscipline), "pony_games")) ? " selected" : ""}>Jeux de poneys</option><option value="western" data-v-8fc5759f${ssrIncludeBooleanAttr(Array.isArray(unref(selectedDiscipline)) ? ssrLooseContain(unref(selectedDiscipline), "western") : ssrLooseEqual(unref(selectedDiscipline), "western")) ? " selected" : ""}>Western</option></select><select class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-equestrian-brown focus:border-blue-600" data-v-8fc5759f><option value="" data-v-8fc5759f${ssrIncludeBooleanAttr(Array.isArray(unref(selectedLevel)) ? ssrLooseContain(unref(selectedLevel), "") : ssrLooseEqual(unref(selectedLevel), "")) ? " selected" : ""}>Tous les niveaux</option><option value="beginner" data-v-8fc5759f${ssrIncludeBooleanAttr(Array.isArray(unref(selectedLevel)) ? ssrLooseContain(unref(selectedLevel), "beginner") : ssrLooseEqual(unref(selectedLevel), "beginner")) ? " selected" : ""}>D\xE9butant</option><option value="intermediate" data-v-8fc5759f${ssrIncludeBooleanAttr(Array.isArray(unref(selectedLevel)) ? ssrLooseContain(unref(selectedLevel), "intermediate") : ssrLooseEqual(unref(selectedLevel), "intermediate")) ? " selected" : ""}>Interm\xE9diaire</option><option value="advanced" data-v-8fc5759f${ssrIncludeBooleanAttr(Array.isArray(unref(selectedLevel)) ? ssrLooseContain(unref(selectedLevel), "advanced") : ssrLooseEqual(unref(selectedLevel), "advanced")) ? " selected" : ""}>Avanc\xE9</option><option value="competition" data-v-8fc5759f${ssrIncludeBooleanAttr(Array.isArray(unref(selectedLevel)) ? ssrLooseContain(unref(selectedLevel), "competition") : ssrLooseEqual(unref(selectedLevel), "competition")) ? " selected" : ""}>Comp\xE9tition</option></select></div></div></div></section><section class="py-12" data-v-8fc5759f><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-8fc5759f>`);
      if (unref(pending)) {
        ...
        _push(`<h3 class="text-lg font-semibold" data-v-8fc5759f>Erreur de chargement</h3><p class="text-gray-600" data-v-8fc5759f>${ssrInterpolate(unref(error).message)}</p></div><button class="btn-primary bg-blue-600 text-white" data-v-8fc5759f> R\xE9essayer </button></div>`);
        ...
        ssrRenderList(unref(filteredTeachers), (teacher) => {
          ...
          ])}" data-v-8fc5759f>${ssrInterpolate(teacher.is_available ? "Disponible" : "Occup\xE9")}</span></div></div><div class="p-6" data-v-8fc5759f><div class="mb-4" data-v-8fc5759f><h3 class="text-xl font-bold text-gray-900 mb-1" data-v-8fc5759f>${ssrInterpolate(teacher.first_name)} ${ssrInterpolate(teacher.last_name)}</h3><p class="text-gray-700" data-v-8fc5759f>${ssrInterpolate(teacher.title || "Instructeur \xE9questre")}</p></div>`);
          ...
          if (teacher.is_available) {
            _push(`<button class="btn-secondary border-blue-600 text-gray-700 hover:bg-blue-700 hover:text-white" data-v-8fc5759f> R\xE9server </button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div></div>`);
        ...
        _push(`<h3 class="text-lg font-semibold text-gray-600 mb-2" data-v-8fc5759f>Aucun professeur trouv\xE9</h3><p class="text-gray-500" data-v-8fc5759f>Essayez de modifier vos crit\xE8res de recherche</p></div>`);
      }
      _push(`</div></section><section class="py-16 bg-equestrian-lightBrown" data-v-8fc5759f><div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8" data-v-8fc5759f><h2 class="text-3xl font-bold text-gray-900 mb-4" data-v-8fc5759f> Vous \xEAtes instructeur ? </h2><p class="text-xl text-gray-700 mb-8" data-v-8fc5759f> Rejoignez notre plateforme et partagez votre passion pour l&#39;\xE9quitation </p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
...
//# sourceMappingURL=teachers-BH8TNywP.mjs.map
