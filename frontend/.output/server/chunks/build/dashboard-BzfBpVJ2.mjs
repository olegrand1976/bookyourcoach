...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="ml-4"><p class="text-sm font-medium text-gray-600">\xC9l\xE8ves actifs</p><p class="text-2xl font-bold text-gray-900">${ssrInterpolate(stats.value.active_students)}</p></div></div></div><div class="bg-white rounded-lg shadow p-6"><div class="flex items-center"><div class="p-2 bg-yellow-100 rounded-lg">`);
      _push(ssrRenderComponent(_component_EquestrianIcon, {
        name: "saddle",
        size: 24,
      ...
      if (upcomingLessons.value.length > 0) {
        ...
        _push(`<p class="text-gray-500">Aucun cours planifi\xE9</p></div>`);
      }
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div${_scopeId}><p class="font-medium text-gray-900"${_scopeId}>G\xE9rer mon planning</p><p class="text-sm text-gray-600"${_scopeId}>D\xE9finir mes disponibilit\xE9s</p></div>`);
          } else {
            return [
              ...
              createVNode("div", null, [
                createVNode("p", { class: "font-medium text-gray-900" }, "G\xE9rer mon planning"),
                createVNode("p", { class: "text-sm text-gray-600" }, "D\xE9finir mes disponibilit\xE9s")
              ])
            ];
          }
        }),
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div${_scopeId}><p class="font-medium text-gray-900"${_scopeId}>Mes \xE9l\xE8ves</p><p class="text-sm text-gray-600"${_scopeId}>Suivi et progression</p></div>`);
          } else {
            return [
              createVNode(_component_EquestrianIcon, {
                name: "trophy",
              ...
              createVNode("div", null, [
                createVNode("p", { class: "font-medium text-gray-900" }, "Mes \xE9l\xE8ves"),
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-xl mr-3"${_scopeId}>\u{1F4B0}</span><div${_scopeId}><p class="font-medium text-gray-900"${_scopeId}>Mes revenus</p><p class="text-sm text-gray-600"${_scopeId}>Paiements et statistiques</p></div>`);
          } else {
            return [
              createVNode("span", { class: "text-xl mr-3" }, "\u{1F4B0}"),
              createVNode("div", null, [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-xl mr-3"${_scopeId}>\u{1F464}</span><div${_scopeId}><p class="font-medium text-gray-900"${_scopeId}>Mon profil</p><p class="text-sm text-gray-600"${_scopeId}>Informations personnelles</p></div>`);
          } else {
            return [
              createVNode("span", { class: "text-xl mr-3" }, "\u{1F464}"),
              createVNode("div", null, [
      ...
      _push(`</div></div></div><div class="bg-white rounded-lg shadow"><div class="p-6 border-b border-gray-200"><h3 class="text-lg font-medium text-gray-900">Aper\xE7u de la semaine</h3></div><div class="p-6"><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4"><div class="text-center"><p class="text-2xl font-bold text-blue-600">${ssrInterpolate(stats.value.week_lessons)}</p><p class="text-sm text-gray-600">Cours cette semaine</p></div><div class="text-center"><p class="text-2xl font-bold text-green-600">${ssrInterpolate(stats.value.week_hours)}</p><p class="text-sm text-gray-600">Heures enseign\xE9es</p></div><div class="text-center"><p class="text-2xl font-bold text-yellow-600">${ssrInterpolate(stats.value.week_earnings)}\u20AC</p><p class="text-sm text-gray-600">Revenus de la semaine</p></div><div class="text-center"><p class="text-2xl font-bold text-purple-600">${ssrInterpolate(stats.value.new_students)}</p><p class="text-sm text-gray-600">Nouveaux \xE9l\xE8ves</p></div></div></div></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=dashboard-BzfBpVJ2.mjs.map
