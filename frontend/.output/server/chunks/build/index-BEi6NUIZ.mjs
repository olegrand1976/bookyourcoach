  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`</div><div class="overflow-x-auto"><table class="min-w-full"><thead class="border-b border-gray-200"><tr><th class="py-3 text-left text-xs font-medium text-gray-500 uppercase">Nom</th><th class="py-3 text-left text-xs font-medium text-gray-500 uppercase">R\xF4le</th><th class="py-3 text-left text-xs font-medium text-gray-500 uppercase">Statut</th></tr></thead><tbody><!--[-->`);
        ...
        _push(`<!--]--></tbody></table></div></div><div class="space-y-8"><div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-200"><h2 class="text-xl font-bold text-gray-800 mb-6">\xC9tat du syst\xE8me</h2><div class="space-y-4"><!--[-->`);
        ...
        _push(`<!--]--></div></div><div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-200"><h2 class="text-xl font-bold text-gray-800 mb-6">Actions rapides</h2><div class="space-y-3"><button class="w-full flex items-center justify-center px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg> Cr\xE9er un utilisateur </button><button class="w-full flex items-center justify-center px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors"><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg> Cr\xE9er un club </button></div></div></div></div></div>`);
      }
      if (showCreateUserModal.value) {
        _push(`<div class="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50 p-4"><div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto"><div class="p-8"><h3 class="text-xl font-bold text-gray-800 mb-6">Cr\xE9er un nouvel utilisateur</h3><form class="space-y-6"><div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div><label class="block text-sm font-medium text-gray-700">Pr\xE9nom *</label><input${ssrRenderAttr("value", newUser.value.first_name)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required></div><div><label class="block text-sm font-medium text-gray-700">Nom *</label><input${ssrRenderAttr("value", newUser.value.last_name)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required></div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div><label class="block text-sm font-medium text-gray-700">Email *</label><input${ssrRenderAttr("value", newUser.value.email)} type="email" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required></div><div><label class="block text-sm font-medium text-gray-700">T\xE9l\xE9phone</label><input${ssrRenderAttr("value", newUser.value.phone)} type="tel" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"></div></div><div><label class="block text-sm font-medium text-gray-700">Date de naissance</label><input${ssrRenderAttr("value", newUser.value.birth_date)} type="date" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"></div><div><label class="block text-sm font-medium text-gray-700">Adresse</label><div class="grid grid-cols-1 md:grid-cols-3 gap-4"><div class="md:col-span-2"><label class="block text-xs text-gray-500 mb-1">Rue</label><input${ssrRenderAttr("value", newUser.value.street)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Nom de la rue"></div><div><label class="block text-xs text-gray-500 mb-1">Num\xE9ro</label><input${ssrRenderAttr("value", newUser.value.street_number)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="92, 92/A, 92B..."></div></div><div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4"><div><label class="block text-xs text-gray-500 mb-1">Code postal</label><input${ssrRenderAttr("value", newUser.value.postal_code)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="1000"></div><div><label class="block text-xs text-gray-500 mb-1">Ville</label><input${ssrRenderAttr("value", newUser.value.city)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Bruxelles"></div><div><label class="block text-xs text-gray-500 mb-1">Pays</label><select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><option value="Belgium"${ssrIncludeBooleanAttr(Array.isArray(newUser.value.country) ? ssrLooseContain(newUser.value.country, "Belgium") : ssrLooseEqual(newUser.value.country, "Belgium")) ? " selected" : ""}>Belgique</option><option value="France"${ssrIncludeBooleanAttr(Array.isArray(newUser.value.country) ? ssrLooseContain(newUser.value.country, "France") : ssrLooseEqual(newUser.value.country, "France")) ? " selected" : ""}>France</option><option value="Netherlands"${ssrIncludeBooleanAttr(Array.isArray(newUser.value.country) ? ssrLooseContain(newUser.value.country, "Netherlands") : ssrLooseEqual(newUser.value.country, "Netherlands")) ? " selected" : ""}>Pays-Bas</option><option value="Germany"${ssrIncludeBooleanAttr(Array.isArray(newUser.value.country) ? ssrLooseContain(newUser.value.country, "Germany") : ssrLooseEqual(newUser.value.country, "Germany")) ? " selected" : ""}>Allemagne</option><option value="Luxembourg"${ssrIncludeBooleanAttr(Array.isArray(newUser.value.country) ? ssrLooseContain(newUser.value.country, "Luxembourg") : ssrLooseEqual(newUser.value.country, "Luxembourg")) ? " selected" : ""}>Luxembourg</option><option value="Switzerland"${ssrIncludeBooleanAttr(Array.isArray(newUser.value.country) ? ssrLooseContain(newUser.value.country, "Switzerland") : ssrLooseEqual(newUser.value.country, "Switzerland")) ? " selected" : ""}>Suisse</option></select></div></div></div><div><label class="block text-sm font-medium text-gray-700">R\xF4le *</label><select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required><option value="student"${ssrIncludeBooleanAttr(Array.isArray(newUser.value.role) ? ssrLooseContain(newUser.value.role, "student") : ssrLooseEqual(newUser.value.role, "student")) ? " selected" : ""}>\xC9l\xE8ve</option><option value="teacher"${ssrIncludeBooleanAttr(Array.isArray(newUser.value.role) ? ssrLooseContain(newUser.value.role, "teacher") : ssrLooseEqual(newUser.value.role, "teacher")) ? " selected" : ""}>Enseignant</option><option value="admin"${ssrIncludeBooleanAttr(Array.isArray(newUser.value.role) ? ssrLooseContain(newUser.value.role, "admin") : ssrLooseEqual(newUser.value.role, "admin")) ? " selected" : ""}>Administrateur</option></select></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div><label class="block text-sm font-medium text-gray-700">Mot de passe *</label><input${ssrRenderAttr("value", newUser.value.password)} type="password" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required></div><div><label class="block text-sm font-medium text-gray-700">Confirmer le mot de passe *</label><input${ssrRenderAttr("value", newUser.value.password_confirmation)} type="password" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required></div></div><div class="form-button-group mt-6"><button type="button" class="btn-secondary">Annuler</button><button type="submit" class="btn-primary">Cr\xE9er</button></div></form></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showCreateClubModal.value) {
        _push(`<div class="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50"><div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md"><h3 class="text-xl font-bold text-gray-800 mb-6">Cr\xE9er un nouveau club</h3><form class="space-y-4"><div><label class="block text-sm font-medium text-gray-700">Nom du club</label><input${ssrRenderAttr("value", newClub.value.name)} type="text" class="w-full mt-1 px-4 py-3 border border-gray-300 rounded-lg" required></div><div><label class="block text-sm font-medium text-gray-700">Email</label><input${ssrRenderAttr("value", newClub.value.email)} type="email" class="w-full mt-1 px-4 py-3 border border-gray-300 rounded-lg" required></div><div><label class="block text-sm font-medium text-gray-700">T\xE9l\xE9phone</label><input${ssrRenderAttr("value", newClub.value.phone)} type="tel" class="w-full mt-1 px-4 py-3 border border-gray-300 rounded-lg"></div><div><label class="block text-sm font-medium text-gray-700">Adresse</label><div class="grid grid-cols-1 md:grid-cols-3 gap-4"><div class="md:col-span-2"><label class="block text-xs text-gray-500 mb-1">Rue</label><input${ssrRenderAttr("value", newClub.value.street)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Nom de la rue"></div><div><label class="block text-xs text-gray-500 mb-1">Num\xE9ro</label><input${ssrRenderAttr("value", newClub.value.street_number)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="92, 92/A, 92B..."></div></div><div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4"><div><label class="block text-xs text-gray-500 mb-1">Code postal</label><input${ssrRenderAttr("value", newClub.value.postal_code)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="1000"></div><div><label class="block text-xs text-gray-500 mb-1">Ville</label><input${ssrRenderAttr("value", newClub.value.city)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Bruxelles"></div><div><label class="block text-xs text-gray-500 mb-1">Pays</label><select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><option value="Belgium"${ssrIncludeBooleanAttr(Array.isArray(newClub.value.country) ? ssrLooseContain(newClub.value.country, "Belgium") : ssrLooseEqual(newClub.value.country, "Belgium")) ? " selected" : ""}>Belgique</option><option value="France"${ssrIncludeBooleanAttr(Array.isArray(newClub.value.country) ? ssrLooseContain(newClub.value.country, "France") : ssrLooseEqual(newClub.value.country, "France")) ? " selected" : ""}>France</option><option value="Netherlands"${ssrIncludeBooleanAttr(Array.isArray(newClub.value.country) ? ssrLooseContain(newClub.value.country, "Netherlands") : ssrLooseEqual(newClub.value.country, "Netherlands")) ? " selected" : ""}>Pays-Bas</option><option value="Germany"${ssrIncludeBooleanAttr(Array.isArray(newClub.value.country) ? ssrLooseContain(newClub.value.country, "Germany") : ssrLooseEqual(newClub.value.country, "Germany")) ? " selected" : ""}>Allemagne</option></select></div></div></div><div class="flex justify-end space-x-4 pt-6 border-t border-gray-200"><button type="button" class="btn-secondary">Annuler</button><button type="submit" class="btn-primary">Cr\xE9er</button></div></form></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=index-BEi6NUIZ.mjs.map
