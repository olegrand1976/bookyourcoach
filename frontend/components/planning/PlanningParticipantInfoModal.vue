...
function subTotalLessons(sub: { remaining_lessons?: number; lessons_used?: number; subscription?: { template?: { total_lessons?: number } } }): string {
  const t = sub.subscription?.template?.total_lessons
