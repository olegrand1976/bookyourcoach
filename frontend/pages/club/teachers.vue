            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center space-x-2">
                <button 
                  ...
                  class="text-green-600 hover:text-green-800 p-2 hover:bg-green-50 rounded-lg transition-colors disabled:opacity-50"
                  title="Renvoyer l'email de réinitialisation de mot de passe"
                >
                  <svg v-if="resending[teacher.id]" class="animate-spin h-5 w-5" fill="none" viewBox="0 0 24 24">
