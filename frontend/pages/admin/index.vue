        ...
        <div class="space-y-8">
          ...
          <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
            ...
            <div class="space-y-3">
              ...
              <button @click="showCreateClubModal = true" class="w-full flex items-center justify-center px-4 py-3 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
