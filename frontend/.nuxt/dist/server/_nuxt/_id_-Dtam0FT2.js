  ...
  async setup(__props) {
      ...
      meta: [
        {
          ...
          content: computed(() => {
            var _a;
            return ((_a = teacher.value) == null ? void 0 : _a.bio) || "Profil d'instructeur équestre sur Acti'Vibe";
          })
        }
      ]
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        _push(`</div><div class="bg-white rounded-xl shadow-lg p-6"><h2 class="text-2xl font-bold text-gray-900 mb-4"> Avis des élèves </h2>`);
        ...
        _push(`</div></div><div class="space-y-6"><div class="bg-white rounded-xl shadow-lg p-6"><h3 class="text-xl font-bold text-gray-900 mb-4"> Réserver un cours </h3>`);
        if (unref(teacher).is_available) {
          ...
          _push(` Réserver maintenant </button><button class="w-full btn-secondary border-blue-600 text-gray-700 hover:bg-blue-700 hover:text-white">`);
          _push(ssrRenderComponent(_component_Icon, {
...
//# sourceMappingURL=_id_-Dtam0FT2.js.map
