...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gray-50" }, _attrs))}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8"><div class="text-center"><h1 class="text-3xl font-bold text-gray-900 mb-4"> 🏇 Disciplines </h1><p class="text-gray-700 mb-8"> Explorez toutes les disciplines disponibles </p><div class="bg-white rounded-lg shadow-lg p-6"><p class="text-gray-700"> Cette page sera bientôt disponible avec la liste complète des disciplines. </p>`);
...
//# sourceMappingURL=disciplines-BkVloqFd.js.map
