...
import { _ as __nuxt_component_0 } from "./nuxt-link-BxC6TOEk.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div><h3 class="text-lg font-semibold text-gray-900">Élèves</h3><p class="text-3xl font-bold text-purple-600">${ssrInterpolate(stats.value.students)}</p><p class="text-sm text-gray-500">Apprenants</p></div></div></div><div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-orange-500"><div class="flex items-center">`);
        _push(ssrRenderComponent(_component_EquestrianIcon, {
          icon: "horse",
          class: "text-orange-500 mr-3",
          size: 24
        }, null, _parent));
        _push(`<div><h3 class="text-lg font-semibold text-gray-900">Clubs</h3><p class="text-3xl font-bold text-orange-600">${ssrInterpolate(stats.value.clubs)}</p><p class="text-sm text-gray-500">Centres équestres</p></div></div></div></div>`);
      }
      ...
      _push(` Créer un utilisateur </button><button class="btn-secondary flex items-center justify-center">`);
      _push(ssrRenderComponent(_component_EquestrianIcon, {
        icon: "horse",
        class: "mr-2",
        size: 16
      }, null, _parent));
      _push(` Créer un club </button>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createTextVNode(" Gérer les utilisateurs ")
            ];
          }
        }),
        _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createTextVNode(" Paramètres système ")
            ];
          }
        }),
        _: 1
      ...
      _push(` Activité récente </h2><div class="space-y-3"><!--[-->`);
      ...
      _push(` Derniers utilisateurs </h2><div class="overflow-x-auto"><table class="min-w-full divide-y divide-gray-200"><thead><tr><th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"> Nom</th><th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"> Rôle</th><th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"> Statut </th></tr></thead><tbody class="divide-y divide-gray-200"><!--[-->`);
      ...
      _push(` État du système </h2><div class="space-y-4"><!--[-->`);
...
//# sourceMappingURL=index-DXBp9dzQ.js.map
