...
import { ssrRenderAttrs, ssrRenderClass, ssrRenderAttr, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderList, ssrLooseContain, ssrLooseEqual, ssrRenderComponent } from "vue/server-renderer";
...
import { _ as _sfc_main$2 } from "./AddTeacherModal-BKhXm82n.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (activeTab.value === "search") {
        ...
        if (searchResults.value.length > 0) {
          _push(`<div class="space-y-2"><h5 class="text-sm font-medium text-gray-700">Résultats</h5><div class="space-y-2"><!--[-->`);
        ...
        if (searchQuery.value && searchResults.value.length === 0 && !isSearching.value) {
          _push(`<div class="text-center py-8 text-gray-500"><svg class="mx-auto h-12 w-12 text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg><p>Aucun enseignant trouvé</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
      ...
      if (activeTab.value === "new") {
        _push(`<div class="space-y-6"><div class="bg-emerald-50 rounded-xl p-6"><div class="flex items-center mb-4"><div class="bg-emerald-100 p-2 rounded-lg mr-3"><svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg></div><div><h4 class="text-lg font-semibold text-gray-900">Créer un nouvel enseignant</h4><p class="text-sm text-gray-600">Ajouter un enseignant qui n&#39;existe pas encore</p></div></div><div class="text-center py-8"><svg class="mx-auto h-12 w-12 text-emerald-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg><h5 class="text-lg font-medium text-gray-900 mb-2">Créer un nouvel enseignant</h5><p class="text-gray-600 mb-6">Utilisez le formulaire de création d&#39;enseignant</p><button class="bg-emerald-600 text-white px-6 py-3 rounded-lg hover:bg-emerald-700 transition-colors font-medium"> Ouvrir le formulaire </button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=teachers-sL3uatUs.js.map
