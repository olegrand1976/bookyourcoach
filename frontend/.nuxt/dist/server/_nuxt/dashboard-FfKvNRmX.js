...
import { _ as _sfc_main$1 } from "./AddTeacherModal-BKhXm82n.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow"><div class="flex items-center justify-between"><div class="flex items-center"><div class="p-3 bg-emerald-100 rounded-lg"><svg class="w-6 h-6 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"></path></svg></div><div class="ml-4"><p class="text-sm font-medium text-gray-600">Élèves</p><p class="text-2xl font-semibold text-gray-900">${ssrInterpolate(((_c = stats.value) == null ? void 0 : _c.total_students) || 0)}</p></div></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/club/students",
      ...
      _push(`</div></div><div class="bg-white rounded-xl shadow-lg overflow-hidden"><div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-emerald-50 to-teal-50"><div class="flex items-center justify-between"><h3 class="text-lg font-semibold text-gray-900">Élèves récents</h3>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/club/students",
        class: "text-emerald-600 hover:text-emerald-800 text-sm font-medium"
      }, {
      ...
      if (((_l = recentStudents.value) == null ? void 0 : _l.length) === 0) {
        _push(`<div class="text-center text-gray-500 py-8"><svg class="mx-auto h-12 w-12 text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"></path></svg><p>Aucun élève pour le moment</p><button class="mt-4 bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition-colors"> Ajouter le premier </button></div>`);
      } else {
        _push(`<div class="space-y-4"><!--[-->`);
...
//# sourceMappingURL=dashboard-FfKvNRmX.js.map
