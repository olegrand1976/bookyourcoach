  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<!--]--></select><select class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><option value="all"${ssrIncludeBooleanAttr(Array.isArray(exceedanceFilter.value) ? ssrLooseContain(exceedanceFilter.value, "all") : ssrLooseEqual(exceedanceFilter.value, "all")) ? " selected" : ""}>Tous les enseignants</option><option value="green"${ssrIncludeBooleanAttr(Array.isArray(exceedanceFilter.value) ? ssrLooseContain(exceedanceFilter.value, "green") : ssrLooseEqual(exceedanceFilter.value, "green")) ? " selected" : ""}>🟢 Dans les limites</option><option value="orange"${ssrIncludeBooleanAttr(Array.isArray(exceedanceFilter.value) ? ssrLooseContain(exceedanceFilter.value, "orange") : ssrLooseEqual(exceedanceFilter.value, "orange")) ? " selected" : ""}>🟠 Zone d&#39;attention</option><option value="red"${ssrIncludeBooleanAttr(Array.isArray(exceedanceFilter.value) ? ssrLooseContain(exceedanceFilter.value, "red") : ssrLooseEqual(exceedanceFilter.value, "red")) ? " selected" : ""}>🔴 Zone critique</option><option value="black"${ssrIncludeBooleanAttr(Array.isArray(exceedanceFilter.value) ? ssrLooseContain(exceedanceFilter.value, "black") : ssrLooseEqual(exceedanceFilter.value, "black")) ? " selected" : ""}>⚫ Dépassements</option></select><button class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700"> Actualiser </button></div></div><div class="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6"><h3 class="text-lg font-semibold text-gray-800 mb-4">Répartition par Statut de Dépassement</h3><div class="grid grid-cols-1 md:grid-cols-4 gap-4"><div class="${ssrRenderClass([{ "ring-2 ring-green-500": exceedanceFilter.value === "green" }, "bg-green-50 border border-green-200 rounded-lg p-3 cursor-pointer hover:bg-green-100 transition-colors"])}"><div class="flex items-center justify-between"><div class="flex items-center space-x-2"><div class="w-3 h-3 bg-green-500 rounded-full"></div><div><p class="text-sm font-medium text-gray-600">Dans les limites</p><p class="text-xs text-gray-500">&lt; ${ssrInterpolate(exceedanceThresholds.value.orange)}%</p></div></div><div class="text-right"><p class="text-xl font-bold text-green-600">${ssrInterpolate(exceedanceStats.value.green)}</p></div></div></div><div class="${ssrRenderClass([{ "ring-2 ring-orange-500": exceedanceFilter.value === "orange" }, "bg-orange-50 border border-orange-200 rounded-lg p-3 cursor-pointer hover:bg-orange-100 transition-colors"])}"><div class="flex items-center justify-between"><div class="flex items-center space-x-2"><div class="w-3 h-3 bg-orange-500 rounded-full"></div><div><p class="text-sm font-medium text-gray-600">Zone d&#39;attention</p><p class="text-xs text-gray-500">${ssrInterpolate(exceedanceThresholds.value.orange)}% - ${ssrInterpolate(exceedanceThresholds.value.red)}%</p></div></div><div class="text-right"><p class="text-xl font-bold text-orange-600">${ssrInterpolate(exceedanceStats.value.orange)}</p></div></div></div><div class="${ssrRenderClass([{ "ring-2 ring-red-500": exceedanceFilter.value === "red" }, "bg-red-50 border border-red-200 rounded-lg p-3 cursor-pointer hover:bg-red-100 transition-colors"])}"><div class="flex items-center justify-between"><div class="flex items-center space-x-2"><div class="w-3 h-3 bg-red-500 rounded-full"></div><div><p class="text-sm font-medium text-gray-600">Zone critique</p><p class="text-xs text-gray-500">${ssrInterpolate(exceedanceThresholds.value.red)}% - 100%</p></div></div><div class="text-right"><p class="text-xl font-bold text-red-600">${ssrInterpolate(exceedanceStats.value.red)}</p></div></div></div><div class="${ssrRenderClass([{ "ring-2 ring-gray-500": exceedanceFilter.value === "black" }, "bg-gray-50 border border-gray-200 rounded-lg p-3 cursor-pointer hover:bg-gray-100 transition-colors"])}"><div class="flex items-center justify-between"><div class="flex items-center space-x-2"><div class="w-3 h-3 bg-gray-800 rounded-full"></div><div><p class="text-sm font-medium text-gray-600">Dépassements</p><p class="text-xs text-gray-500">&gt; 100%</p></div></div><div class="text-right"><p class="text-xl font-bold text-gray-800">${ssrInterpolate(exceedanceStats.value.black)}</p></div></div></div></div></div><div class="space-y-4"><!--[-->`);
        ssrRenderList(filteredTeachers.value, (teacher) => {
          ...
          if (teacher.current_contract) {
            _push(`<div class="bg-gray-50 rounded-lg p-4 mb-4"><h4 class="font-medium text-gray-900 mb-3">Contrat Actuel</h4><div class="grid grid-cols-1 md:grid-cols-3 gap-4"><div><span class="text-sm text-gray-500">Type:</span><p class="font-medium">${ssrInterpolate(getContractTypeLabel(teacher.current_contract.type))}</p></div><div><span class="text-sm text-gray-500">Début:</span><p class="font-medium">${ssrInterpolate(formatDate(teacher.current_contract.start_date))}</p></div><div><span class="text-sm text-gray-500">Fin:</span><p class="font-medium">${ssrInterpolate(teacher.current_contract.end_date ? formatDate(teacher.current_contract.end_date) : "Indéterminé")}</p></div></div></div>`);
          } else {
            _push(`<!---->`);
          }
        ...
        ssrRenderList(filteredTeachers.value, (teacher) => {
          ...
          _push(`<!--]--></div></div><div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4"><div class="bg-gray-50 rounded-lg p-3"><p class="text-sm text-gray-500">Heures ${ssrInterpolate(selectedPeriod.value === "monthly" ? "ce mois" : "cette année")}</p><p class="text-lg font-semibold">${ssrInterpolate(teacher.period_hours || 0)}h</p></div><div class="bg-gray-50 rounded-lg p-3"><p class="text-sm text-gray-500">Montant ${ssrInterpolate(selectedPeriod.value === "monthly" ? "ce mois" : "cette année")}</p><p class="text-lg font-semibold">${ssrInterpolate(teacher.period_amount || 0)}€</p></div><div class="bg-gray-50 rounded-lg p-3"><p class="text-sm text-gray-500">Kilométrage ${ssrInterpolate(selectedPeriod.value === "monthly" ? "ce mois" : "cette année")}</p><p class="text-lg font-semibold">${ssrInterpolate(teacher.period_mileage || 0)}km</p></div></div><div class="border-t pt-4"><h4 class="font-medium text-gray-900 mb-3">Historique des Paiements</h4><div class="overflow-x-auto"><table class="min-w-full divide-y divide-gray-200"><thead class="bg-gray-50"><tr><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Date</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Montant</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Heures</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Kilométrage</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Statut</th></tr></thead><tbody class="bg-white divide-y divide-gray-200"><!--[-->`);
...
//# sourceMappingURL=contracts-C2ybpdFk.js.map
