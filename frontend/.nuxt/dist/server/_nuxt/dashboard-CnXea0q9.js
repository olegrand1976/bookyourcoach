  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(upcomingLessons).length === 0) {
        ...
        _push(`<p class="text-gray-500">Aucun cours planifié</p>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/lessons/book",
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Réserver un nouveau cours `);
          } else {
            return [
              createTextVNode(" Réserver un nouveau cours ")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=dashboard-CnXea0q9.js.map
