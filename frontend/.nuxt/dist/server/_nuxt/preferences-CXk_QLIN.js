...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "preferences-page" }, _attrs))} data-v-a5a1cd9d><div class="container mx-auto px-4 py-8" data-v-a5a1cd9d><div class="mb-8" data-v-a5a1cd9d><h1 class="text-3xl font-bold text-gray-900 mb-2" data-v-a5a1cd9d> 🎯 Mes Préférences </h1><p class="text-gray-700" data-v-a5a1cd9d> Sélectionnez vos disciplines et types de cours préférés </p></div>`);
      if (loading.value) {
        ...
        ])}" data-v-a5a1cd9d>${ssrInterpolate(hasPreferenceForDiscipline("equitation") ? "Sélectionné" : "Sélectionner")}</button>`);
        ...
        if (hasPreferenceForDiscipline("equitation")) {
          ...
          _push(`</button><div data-v-a5a1cd9d><div class="text-sm font-medium text-gray-900" data-v-a5a1cd9d> Dressage Particulier </div><div class="text-xs text-gray-700" data-v-a5a1cd9d> Individuel • Durée variable selon l&#39;enseignant </div></div></div>`);
          if (hasPreferenceForCourseType("equitation", "dressage_particulier")) {
          ...
          _push(`</button><div data-v-a5a1cd9d><div class="text-sm font-medium text-gray-900" data-v-a5a1cd9d> Dressage Collectif </div><div class="text-xs text-gray-700" data-v-a5a1cd9d> Collectif • Durée variable selon l&#39;enseignant </div></div></div>`);
          if (hasPreferenceForCourseType("equitation", "dressage_collectif")) {
            _push(`<div class="flex-shrink-0" data-v-a5a1cd9d><svg class="h-4 w-4 text-green-500" fill="currentColor" viewBox="0 0 20 20" data-v-a5a1cd9d><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" data-v-a5a1cd9d></path></svg></div>`);
          } else {
            _push(`<!---->`);
          ...
          _push(`</button><div data-v-a5a1cd9d><div class="text-sm font-medium text-gray-900" data-v-a5a1cd9d> Obstacles Particulier </div><div class="text-xs text-gray-700" data-v-a5a1cd9d> Individuel • Durée variable selon l&#39;enseignant </div></div></div>`);
          if (hasPreferenceForCourseType("equitation", "obstacles_particulier")) {
            _push(`<div class="flex-shrink-0" data-v-a5a1cd9d><svg class="h-4 w-4 text-green-500" fill="currentColor" viewBox="0 0 20 20" data-v-a5a1cd9d><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" data-v-a5a1cd9d></path></svg></div>`);
          } else {
            _push(`<!---->`);
          ...
          _push(`</button><div data-v-a5a1cd9d><div class="text-sm font-medium text-gray-900" data-v-a5a1cd9d> Obstacles Collectif </div><div class="text-xs text-gray-700" data-v-a5a1cd9d> Collectif • Durée variable selon l&#39;enseignant </div></div></div>`);
          if (hasPreferenceForCourseType("equitation", "obstacles_collectif")) {
            _push(`<div class="flex-shrink-0" data-v-a5a1cd9d><svg class="h-4 w-4 text-green-500" fill="currentColor" viewBox="0 0 20 20" data-v-a5a1cd9d><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" data-v-a5a1cd9d></path></svg></div>`);
          } else {
            _push(`<!---->`);
        ...
        ])}" data-v-a5a1cd9d>${ssrInterpolate(hasPreferenceForDiscipline("natation") ? "Sélectionné" : "Sélectionner")}</button>`);
        ...
        _push(`</div>`);
        if (hasAnyPreference()) {
          _push(`<div class="bg-green-50 border border-green-200 rounded-lg p-6" data-v-a5a1cd9d><div class="flex items-center" data-v-a5a1cd9d><div class="flex-shrink-0" data-v-a5a1cd9d><svg class="h-5 w-5 text-green-400" fill="currentColor" viewBox="0 0 20 20" data-v-a5a1cd9d><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" data-v-a5a1cd9d></path></svg></div><div class="ml-3" data-v-a5a1cd9d><h3 class="text-sm font-medium text-green-800" data-v-a5a1cd9d> Préférences sauvegardées </h3><div class="mt-2 text-sm text-green-700" data-v-a5a1cd9d> Vos préférences ont été enregistrées avec succès. </div></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
//# sourceMappingURL=preferences-CXk_QLIN.js.map
