  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(selectedActivities).length > 0) {
        _push(`<div class="mt-6"><h3 class="text-md font-medium text-equestrian-darkBrown mb-3">Spécialités par activité</h3><!--[-->`);
...
//# sourceMappingURL=profile-unified-B5xYC0hU.js.map
