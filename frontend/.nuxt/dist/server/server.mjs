...
import { sanitizeStatusCode, createError as createError$1 } from "/workspace/frontend/node_modules/h3/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BJpoVmP5.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/login-BYB7cDTj.js")
  },
  {
    name: "profile",
    path: "/profile",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/profile-ghY9xtna.js")
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/register-DLgaQ6s2.js")
  },
  {
    name: "teachers",
    path: "/teachers",
    component: () => import("./_nuxt/teachers-ku20PBWf.js"),
    children: [
      {
        name: "teachers-id",
        path: ":id()",
        component: () => import("./_nuxt/_id_-BXDFncS4.js")
      }
    ]
  },
  {
    name: "test-api",
    path: "/test-api",
    component: () => import("./_nuxt/test-api-CuLyCys3.js")
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/dashboard-BCD_06OH.js")
  },
  {
    name: "test-auth",
    path: "/test-auth",
    component: () => import("./_nuxt/test-auth-DUxUMbFZ.js")
  },
  {
    name: "debug-auth",
    path: "/debug-auth",
    component: () => import("./_nuxt/debug-auth-2oS5ZKmG.js")
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": ["auth", "admin"] } },
    component: () => import("./_nuxt/index-DXBp9dzQ.js")
  },
  {
    name: "admin-users",
    path: "/admin/users",
    meta: { "middleware": "auth-admin" },
    component: () => import("./_nuxt/users-D31dd__D.js")
  },
  {
    name: "admin-settings",
    path: "/admin/settings",
    meta: { "middleware": ["auth", "admin"] },
    component: () => import("./_nuxt/settings-CXtf86t5.js")
  },
  {
    name: "test-api-direct",
    path: "/test-api-direct",
    component: () => import("./_nuxt/test-api-direct-CCShpBwx.js")
  },
  {
    name: "teacher-dashboard",
    path: "/teacher/dashboard",
    meta: { "middleware": ["auth", "teacher"] },
    component: () => import("./_nuxt/dashboard-CI3Ugaa8.js")
  }
];
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-DfNl79WC.js"),
  "auth-admin": () => import("./_nuxt/auth-admin-CpFW-mdN.js"),
  auth: () => import("./_nuxt/auth-BCkW8MjD.js"),
  "role-control": () => import("./_nuxt/role-control-DZ4cSeYd.js")
};
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-DT-HqPEV.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-mhTeHwkf.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-J1mo4CH7.js"));
