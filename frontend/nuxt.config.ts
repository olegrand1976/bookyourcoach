export default defineNuxtConfig({
    ...
    runtimeConfig: {
        public: {
            apiBase: process.env.NUXT_PUBLIC_API_BASE || (process.env.NODE_ENV === 'production' ? 'https://91.134.77.98:8080/api' : 'http://localhost:8001/api'),
            appName: 'Acti\'Vibe'
        },
        // Configuration côté serveur pour Docker
        apiBase: process.env.NUXT_API_BASE || (process.env.NODE_ENV === 'production' ? 'https://91.134.77.98:8080/api' : 'http://localhost:8001/api')
    },
